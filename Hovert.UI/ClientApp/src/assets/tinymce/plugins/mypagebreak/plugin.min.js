...
(function () {
    ...
    var getSeparatorHtml = function (editor) {
      return editor.getParam('pagebreak_separator', '<p class="pagebreak" style="page-break-before: always;" data-mce-style="page-break-before: always;"></p>');
    };
    ...
    var getPlaceholderHtml = function (shouldSplitBlock) {
	  var html = '<p class="pagebreak" style="page-break-before: always;" data-mce-style="page-break-before: always;"></p>';
    ...
    var register$1 = function (editor) {
      editor.ui.registry.addButton('mypagebreak', {
        icon: 'page-break',
        tooltip: 'Page break',
        onAction: function () {
      ...
      editor.ui.registry.addMenuItem('mypagebreak', {
        text: 'Page break',
        icon: 'page-break',
        onAction: function () {
          return editor.execCommand('mcePageBreak');
    ...
    function Plugin () {
      global.add('mypagebreak', function (editor) {
        register(editor);
        register$1(editor);
        setup(editor);
        setup$1(editor);
